                            ...
                            <td>
                                <div class="action-buttons">
                                    <button type="button" class="btn btn-info view-details" data-bs-toggle="tooltip" title="Detail"
                                        ...
                                        data-link-foto-ktp="{{ $warga->foto_ktp ? asset('storage/img/'.$warga->foto_ktp) : '' }}"
                                        data-link-foto-kk="{{ $warga->foto_kk ? asset('storage/img/'.$warga->foto_kk) : '' }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control-file" id="foto_ktp" name="foto_ktp" accept="image/*,application/pdf" required>
                            </div>
                            <div class="form-group">
