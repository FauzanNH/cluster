...
<div class="container-fluid">
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex justify-content-between align-items-center">
            <button type="button" class="btn btn-primary" id="btn-tambah-satpam" data-bs-toggle="modal" data-bs-target="#modalTambahSatpam">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover table-striped" id="satpamTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        @empty
                        <tr>
                            <td colspan="6" class="text-center">Tidak ada data satpam.</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
      ...
      <div class="modal-body">
        <form id="formTambahSatpam">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="tambah-no_hp" name="no_hp" required>
          </div>
          <div class="mb-3">
            <label for="tambah-gender" class="form-label">Gender</label>
            <select class="form-control" id="tambah-gender" name="gender" required>
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="tambah-alamat" name="alamat" required>
          </div>
          <div class="mb-3">
            <label for="tambah-password" class="form-label">Password</label>
            <input type="password" class="form-control" id="tambah-password" name="password" required minlength="6">
          </div>
          <div class="mb-3">
            <label for="tambah-password_confirmation" class="form-label">Konfirmasi Password</label>
            <input type="password" class="form-control" id="tambah-password_confirmation" name="password_confirmation" required minlength="6">
          </div>
        </form>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
        <button type="button" class="btn btn-primary" id="btn-simpan-tambah-satpam">Simpan</button>
      </div>
    </div>
  </div>
</div>
