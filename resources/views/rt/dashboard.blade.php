...
<div class="container-fluid">
        ...
        <div class="col-md-3 mb-4">
            <div class="card dashboard-card card-warga">
                <div class="card-body text-center">
                    ...
                    <p class="card-text counter-animation">150</p>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-3 mb-4">
            <div class="card dashboard-card card-rumah">
                <div class="card-body text-center">
                    ...
                    <p class="card-text counter-animation">45</p>
                </div>
            </div>
        </div>
    ...
    <div class="row mb-4">
        <div class="col-12 mb-3">
            <h4 class="section-header"><i class="fas fa-file-alt me-2"></i>Status Dokumen</h4>
        </div>
        ...
        <div class="col-md-3 mb-4">
            <div class="card status-card status-waiting">
                <div class="card-body text-center">
                    ...
                    <p class="card-text counter-animation">12</p>
        ...
        <div class="col-md-3 mb-4">
            <div class="card status-card status-review">
                <div class="card-body text-center">
                    ...
                    <p class="card-text counter-animation">5</p>
        ...
        <div class="col-md-3 mb-4">
            <div class="card status-card status-approved">
                <div class="card-body text-center">
                    ...
                    <p class="card-text counter-animation">28</p>
        ...
        <div class="col-md-3 mb-4">
            <div class="card status-card status-rejected">
                <div class="card-body text-center">
                    ...
                    <p class="card-text counter-animation">7</p>
