...
<body>
    <div class="email-wrapper">
        <div class="header">
            <!-- <img src="https://bukitasricluster.com/logo.png" alt="Bukit Asri Cluster" class="logo"> -->
        ...
        <div class="content">
            ...
            <div class="message">
                Anda baru saja meminta untuk melakukan perubahan alamat email pada akun Bukit Asri Cluster anda.
                Untuk melanjutkan proses verifikasi, silakan masukkan kode OTP berikut pada aplikasi:
            </div>
            ...
            <div class="warning">
                <strong>Perhatian:</strong> Jangan berikan kode OTP ini kepada siapapun termasuk staff atau admin Bukit Asri Cluster. 
                Jika Anda tidak merasa melakukan permintaan ini, silakan abaikan email ini dan pastikan keamanan akun Anda.
            </div>
